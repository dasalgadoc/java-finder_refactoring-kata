...
public class PeopleTupleByAgeCriteriaFinder {
  ...
  public PeopleTupleByAgeCriteriaFinder(
      List<Person> people, AgeComparorFactory ageComparorFactory) {
    this.people = people;
  ...
  public Optional<PeopleTuple> find(AgeDifferenceCriteria ageDifferenceCriteria) {
    ...
    return Optional.of(
        getRequestedPeopleTupleByAgeCriteria(ageDifferenceCriteria, peopleTuplesCombinations));
  }
  ...
  private List<PeopleTuple> generatePeopleTupleCombinations() {
    ...
    people.sort(
        (firstPerson, secondPerson) ->
            firstPerson
                .getBirthDateInMilliseconds()
                .compareTo(secondPerson.getBirthDateInMilliseconds()));
  ...
  private PeopleTuple getRequestedPeopleTupleByAgeCriteria(
      AgeDifferenceCriteria ageDifferenceCriteria, List<PeopleTuple> peopleTuplesCombinations) {
    AgeComparorByCriteria ageComparorByCriteria =
        ageComparorFactory.getAgeComparor(ageDifferenceCriteria);
