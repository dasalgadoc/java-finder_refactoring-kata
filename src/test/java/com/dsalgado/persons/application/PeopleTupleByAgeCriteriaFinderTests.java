...
public class PeopleTupleByAgeCriteriaFinderTests {
  ...
  public void Returns_Empty_Tuple_When_Given_Empty_List() {
    ...
    PeopleTupleByAgeCriteriaFinder peopleTupleByAgeCriteriaFinder =
        new PeopleTupleByAgeCriteriaFinder(list, ageComparorFactory);

    Optional<PeopleTuple> peopleTuple =
        peopleTupleByAgeCriteriaFinder.find(AgeDifferenceCriteria.Lowest);
  ...
  public void Returns_Furthest_Two_For_Two_People() {
    ...
    Optional<PeopleTuple> peopleTuple =
        peopleTupleByAgeCriteriaFinder.find(AgeDifferenceCriteria.Highest);
